...
<a href="{{ route('School.indexDelete') }}" type="button"
...
<table class="table table-hover mt-2">
 ...
 <td>
 <a href="{{ route('School.edit', $data->ID_School) }}" type="button" class="btn btn-warning rounded-3">Ubah Data</a>
...
<form method="POST" 
action="{{ route('School.delete', $data->ID_School) }}">
 @csrf
